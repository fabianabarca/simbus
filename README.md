# Simulador de datos de rastreo y telemetría para vehículos de transporte público

Este es un simulador de datos "simple" que crea "viajes" 24/7 a una frecuencia alta y constante, con el fin de evaluar sistemas de información en tiempo real, como pantallas y sitios web.
